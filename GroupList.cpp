...
GroupList::GroupListIterator::GroupListIterator(GroupList::Cell *n)
{
    GroupListIterator::current = n;
}
...
{
    auto *iterator = new GroupListIterator(beginning);
...
{
    GroupListIterator *iterator = dynamic_cast<GroupListIterator*>(iter);
    ...
    {
        GroupListIterator *trash = dynamic_cast<GroupListIterator*>(newIterator());
...
GroupList::Iterator* GroupList::find(void *elem, size_t size)
{
    ...
    GroupListIterator* tmp = dynamic_cast<GroupListIterator*>(newIterator());
